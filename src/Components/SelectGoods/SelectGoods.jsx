...
/**
 *   Komponenta zobrazí obsah produktů a obslouží přidání do košíku (vytvoření pole)
 */
function SelectGoods() {
     ...
     * přidání produktů do do košíku ... jen vytváří pole
     */
    ...
    return (
        isNaN(D.dataProduct) &&
        D.dataProduct.map((i) => {
            const [PricePart1, PricePart2] = Number(i.price).toFixed(2).split(".");
            return (
                <Card
                    ...
                    <Col md='12' className='d-flex w-100 h-50 p-3'>
                        <Card.Img variant='top' className='m-auto' src={"./image/products/" + i.img} />
                    </Col>
                    <Card.Body as={Col} md='12' className='h-50 d-flex align-items-stretch flex-column m-0 p-0'>
                        ...
                        <h3 className='mt-auto font3'>
                            {PricePart1}
                            <small className='decimal-part'>.{PricePart2}</small>
                    ...
                    <Card.Footer className='d-flex h-25 e m-0 pb-2 border1 color-white '>
                        <Col md='4' className='d-flex align-items-center flex-column '>
                            <small className='font1 text-center text-dark'>Počet ks.</small>
                            <Form.Control
                        ...
                        <Col md='8' className=' '>
                            <Button
                                ...
                                onClick={() => D.addToCart(i, countProducts[i.id])}>
                                Do košíku
                            </Button>
                        </Col>
                    </Card.Footer>
